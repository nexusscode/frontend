        ...
        <div class="w-[320px] flex flex-col">
            <div class="flex flex-col justify-around h-[200px] p-4 rounded-lg bg-white/60">
                ...
                <div class="w-full text-[10px] flex flex-col">
                    <input type="text" v-model="userInfo.userEmail" placeholder="아이디" class="w-full py-1.5 pl-2.5 border rounded-sm">
                    <input type="text" v-model="userInfo.userPW" placeholder="비밀번호" class="w-full my-1.5 py-1.5 pl-2.5 border rounded-sm">
