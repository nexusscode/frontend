            ...
            <div class="relative h-10 flex items-end w-full">
                ...
                <div class="absolute left-1/2 transform -translate-x-1/2 flex">
                    ...
                    <button
                        ...
                        :key="page"
                        @click="currentPage = page; isLoading = true; fetchSInfo(page)"
...
async function fetchSInfo(page = 1) { // 보관된 실제 면접 전체 조회
    try {
        const response = await env.get('/api/ApplicationReportMemo/storage/saved', {
            params: {
        ...
        console.log("보관된 실제 면접 전체 조회:" + titles.value)
